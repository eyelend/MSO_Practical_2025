...
namespace MSO_P2_Code.Geometry2D
{
    internal abstract class Dir4 //using singleton- and state-pattern 
    {
        ...
        public abstract Dir4 Rotate(Dir2 dir);
        ...
        {
            public override Dir4 Rotate(Dir2 dir) => dir switch { Dir2.Left => West, Dir2.Right => East };
            public override (int x, int y) ToVector() => (0, -1);
        }
        private class _East : Dir4
        {
            public override Dir4 Rotate(Dir2 dir) => dir switch { Dir2.Left => North, Dir2.Right => South };
            public override (int x, int y) ToVector() => (1, 0);
        }
        private class _South : Dir4
        {
            public override Dir4 Rotate(Dir2 dir) => dir switch { Dir2.Left => East, Dir2.Right => West };
            public override (int x, int y) ToVector() => (0, 1);
        }
        private class _West : Dir4
        {
            public override Dir4 Rotate(Dir2 dir) => dir switch { Dir2.Left => South, Dir2.Right => North };
            public override (int x, int y) ToVector() => (-1, 0);
        }
        #endregion instances
